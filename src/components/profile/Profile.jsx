        ...
        <div className="row">
            <div className="p-all text-center col-12" style={backgroundImage}>
                ...
                <dl>
                    ...
                    <dd>生年月日・年齢</dd>
                    <dt className="pv">1998/02/24 ・ 24才</dt>
                    <dd>職業</dd>
                    <dt className="pv">システムエンジニア</dt>
                    <dd>趣味</dd>
                    <dt className="pv">カラオケ、漫画、アニメ、お酒、サウナ、運動</dt>
                    <dd>メッセージ</dd>
                    <dt className="pv">
                        完全に熱意だけでエンジニアになった僕ですが、業務の中での学びだけでなく、<br />
                        プログラミングスクールに通うなど、自分のスキルを高めるため行動をし続けています！<br />
                        現在はフリーランスエンジニア、プログラミングスクール講師として活動しています。<br />
